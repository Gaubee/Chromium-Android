...
public class ContextualSearchFieldTrial {
    ...
    private static final Boolean[] sSwitches = new Boolean[ContextualSearchSwitch.NUM_ENTRIES];
    private static final Integer[] sSettings = new Integer[ContextualSearchSetting.NUM_ENTRIES];
    ...
    private static boolean detectEnabled() {
        ...
        return !getBooleanParam(DISABLED_PARAM);
    }
