...
public interface ViewActionManager {
     ...
     * viewport.
     */
    void setViewport(@Nullable View viewport);

    /** Signals that a view with associated reportable content has become visible. */
    void onViewVisible(View view, String contentId, ActionPayload actionPayload);

    /** Signals that a view with associated reportable content has become hidden. */
    void onViewHidden(View view, String contentId);
     ...
     */
    void storeViewActions(Runnable doneCallback);
}
