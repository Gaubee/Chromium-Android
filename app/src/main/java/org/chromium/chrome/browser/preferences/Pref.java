...
public final class Pref {
    ...
    public static final String SODA_DE_DE_CONFIG_PATH = "accessibility.captions.soda_de_de_config_path";

    // The file path of the es-ES Speech On-Device API (SODA) configuration file.
    public static final String SODA_ES_ES_CONFIG_PATH = "accessibility.captions.soda_es_es_config_path";

    // The file path of the fr-FR Speech On-Device API (SODA) configuration file.
    public static final String SODA_FR_FR_CONFIG_PATH = "accessibility.captions.soda_fr_fr_config_path";

    // The file path of the it-IT Speech On-Device API (SODA) configuration file.
    public static final String SODA_IT_IT_CONFIG_PATH = "accessibility.captions.soda_it_it_config_path";
    ...
    public static final String CART_MODULE_REMOVED = "cart_module_removed";
