...
class PlayerFrameBitmapPainter {
     ...
     */
    private final Set<CompressibleBitmap> mBitmapsToKeep = new HashSet<>();
    /**
     ...
     */
    private final Set<CompressibleBitmap> mInflatingBitmaps = new HashSet<>();
    /**
     ...
     */
    private final Set<CompressibleBitmap> mInflatedBitmaps = new HashSet<>();
