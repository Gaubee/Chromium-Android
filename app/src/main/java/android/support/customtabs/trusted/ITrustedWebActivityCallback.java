...
public interface ITrustedWebActivityCallback extends android.os.IInterface
{
  ...
  class Default implements android.support.customtabs.trusted.ITrustedWebActivityCallback
  {
  ...
  abstract class Stub extends android.os.Binder implements android.support.customtabs.trusted.ITrustedWebActivityCallback
  {
  ...
  void onExtraCallback(java.lang.String callbackName, android.os.Bundle bundle) throws android.os.RemoteException;
}
