...
public final class GpuPreferences extends org.chromium.mojo.bindings.Struct {
    ...
    public static GpuPreferences decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new GpuPreferences(elementsOrVersion);
                ...
                result.enableGpuBlockedTimeMetric = decoder0.readBoolean(29, 3);
                }
                {
                    
                result.enablePerfDataCollection = decoder0.readBoolean(29, 4);
                }
                {
                    
                result.enableNativeGpuMemoryBuffers = decoder0.readBoolean(29, 5);
                }
                {
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.enableGpuBlockedTimeMetric, 29, 3);
        
        encoder0.encode(this.enablePerfDataCollection, 29, 4);
        
        encoder0.encode(this.enableNativeGpuMemoryBuffers, 29, 5);
        ...
        if (this.enabledDawnFeaturesList == null) {
            ...
            org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.enabledDawnFeaturesList.length, 56, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
        ...
        if (this.disabledDawnFeaturesList == null) {
            ...
            org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.disabledDawnFeaturesList.length, 64, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
