...
public class AutofillAssistantArguments {
    ...
    public static class Builder {
        private final AutofillAssistantArguments mArguments;
    ...
    private final Map<String, Object> mAutofillAssistantParameters;
    private final Map<String, Object> mIntentExtras;
