...
final class VrModuleProviderJni implements VrModuleProvider.Natives {
  ...
  public static final JniStaticTestMocker<VrModuleProvider.Natives> TEST_HOOKS = new JniStaticTestMocker<VrModuleProvider.Natives>() {
    @Override
    public void setInstanceForTesting(
        VrModuleProvider.Natives instance) {
