// WebBundleTokenParams.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class WebBundleTokenParams extends org.chromium.mojo.bindings.Struct {
    ...
    public static WebBundleTokenParams deserialize(org.chromium.mojo.bindings.Message message) {
    ...
    public static WebBundleTokenParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        decoder0.increaseStackDepth();
        WebBundleTokenParams result;
        try {
            ...
            result = new WebBundleTokenParams(elementsOrVersion);
                ...
                result.webBundleHandle = decoder0.readServiceInterface(16, true, WebBundleHandle.MANAGER);
                }
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.webBundleHandle, 16, true, WebBundleHandle.MANAGER);
    }
}