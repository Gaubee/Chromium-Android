...
final class PwaBottomSheetControllerJni implements PwaBottomSheetController.Natives {
  ...
  @Override
  public void createAndShowBottomSheetInstaller(WebContents webContents) {
    GEN_JNI.org_chromium_chrome_browser_webapps_PwaBottomSheetController_createAndShowBottomSheetInstaller(webContents);
  }
