...
public interface ITrustedWebActivityService extends android.os.IInterface
{
  ...
  class Default implements android.support.customtabs.trusted.ITrustedWebActivityService
  {
  ...
  abstract class Stub extends android.os.Binder implements android.support.customtabs.trusted.ITrustedWebActivityService
  {
  ...
  android.os.Bundle areNotificationsEnabled(android.os.Bundle args) throws android.os.RemoteException;
  android.os.Bundle notifyNotificationWithChannel(android.os.Bundle args) throws android.os.RemoteException;
  void cancelNotification(android.os.Bundle args) throws android.os.RemoteException;
  ...
  android.os.Bundle extraCommand(java.lang.String commandName, android.os.Bundle args, android.os.IBinder callback) throws android.os.RemoteException;
}
