...
org.chromium.mojo.bindings.InterfaceRequest<RestrictedCookieManager> restrictedCookieManager, int role, IsolationInfo isolationInfo, CookieAccessObserver cookieObserver) {
...
boolean enabled) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case GET_RESTRICTED_COOKIE_MANAGER_ORDINAL: {
                        ...
                        getImpl().getRestrictedCookieManager(data.restrictedCookieManager, data.role, data.isolationInfo, data.cookieObserver);
                        return true;
                    }
    ...
    static final class NetworkContextGetRestrictedCookieManagerParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static NetworkContextGetRestrictedCookieManagerParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new NetworkContextGetRestrictedCookieManagerParams(elementsOrVersion);
                    ...
                    result.cookieObserver = decoder0.readServiceInterface(24, true, CookieAccessObserver.MANAGER);
                    }
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.cookieObserver, 24, true, CookieAccessObserver.MANAGER);
        }
    }
