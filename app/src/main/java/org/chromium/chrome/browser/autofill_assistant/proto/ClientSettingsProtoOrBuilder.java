...
public interface ClientSettingsProtoOrBuilder extends
   ...
   * @return Whether the slowWarningSettings field is set.
   */
  boolean hasSlowWarningSettings();
  /**
   * <code>optional .autofill_assistant.ClientSettingsProto.SlowWarningSettings slow_warning_settings = 21;</code>
   * @return The slowWarningSettings.
   */
  org.chromium.chrome.browser.autofill_assistant.proto.ClientSettingsProto.SlowWarningSettings getSlowWarningSettings();
}
