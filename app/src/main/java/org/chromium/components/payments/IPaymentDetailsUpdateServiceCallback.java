...
public interface IPaymentDetailsUpdateServiceCallback extends android.os.IInterface
{
  ...
  class Default implements org.chromium.components.payments.IPaymentDetailsUpdateServiceCallback
  {
    /**
  ...
  abstract class Stub extends android.os.Binder implements org.chromium.components.payments.IPaymentDetailsUpdateServiceCallback
  {
  ...
  /**
       ...
       *      the merchant.
       */
  void updateWith(android.os.Bundle updatedPaymentDetails) throws android.os.RemoteException;
  /**
       * Called to notify the invoked payment app that the merchant has not
       * modified the payment details.
       */
  void paymentDetailsNotUpdated() throws android.os.RemoteException;
}
