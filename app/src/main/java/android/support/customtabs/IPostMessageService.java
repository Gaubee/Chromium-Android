...
public interface IPostMessageService extends android.os.IInterface
{
  ...
  class Default implements android.support.customtabs.IPostMessageService
  {
  ...
  abstract class Stub extends android.os.Binder implements android.support.customtabs.IPostMessageService
  {
  ...
  void onMessageChannelReady(android.support.customtabs.ICustomTabsCallback callback, android.os.Bundle extras) throws android.os.RemoteException;
  void onPostMessage(android.support.customtabs.ICustomTabsCallback callback, java.lang.String message, android.os.Bundle extras) throws android.os.RemoteException;
}
