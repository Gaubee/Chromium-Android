...
public class PlayerFrameBitmapState {
    ...
    private void clearBeforeRequest() {
        ...
        assert (mVisibleBitmaps.length <= 0) || mVisibleBitmaps[0].length == mRequiredBitmaps[0].length;
    ...
    private void cancelUnrequiredPendingRequests() {
        ...
        assert (mPendingBitmapRequests.length <= 0) || mPendingBitmapRequests[0].length == mRequiredBitmaps[0].length;
