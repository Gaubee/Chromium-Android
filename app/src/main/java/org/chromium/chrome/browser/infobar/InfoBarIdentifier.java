...
@IntDef({
    ...
    InfoBarIdentifier.SYSTEM_INFOBAR_DELEGATE_MAC,
    InfoBarIdentifier.EXPERIMENTAL_INFOBAR_DELEGATE_LACROS,
    InfoBarIdentifier.ROSETTA_REQUIRED_INFOBAR_DELEGATE,
    InfoBarIdentifier.WEBID_PERMISSION_INFOBAR_DELEGATE,
...
public @interface InfoBarIdentifier {
  ...
  int SYSTEM_INFOBAR_DELEGATE_MAC = 101;
  int EXPERIMENTAL_INFOBAR_DELEGATE_LACROS = 102;
  int ROSETTA_REQUIRED_INFOBAR_DELEGATE = 103;
  int WEBID_PERMISSION_INFOBAR_DELEGATE = 104;
