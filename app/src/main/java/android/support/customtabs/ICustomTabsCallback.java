...
public interface ICustomTabsCallback extends android.os.IInterface
{
  ...
  class Default implements android.support.customtabs.ICustomTabsCallback
  {
  ...
  abstract class Stub extends android.os.Binder implements android.support.customtabs.ICustomTabsCallback
  {
  ...
  void extraCallback(java.lang.String callbackName, android.os.Bundle args) throws android.os.RemoteException;
  void onMessageChannelReady(android.os.Bundle extras) throws android.os.RemoteException;
  void onPostMessage(java.lang.String message, android.os.Bundle extras) throws android.os.RemoteException;
  void onRelationshipValidationResult(int relation, android.net.Uri origin, boolean result, android.os.Bundle extras) throws android.os.RemoteException;
  android.os.Bundle extraCallbackWithResult(java.lang.String callbackName, android.os.Bundle args) throws android.os.RemoteException;
}
