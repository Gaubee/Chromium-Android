...
public class AutofillProvider {
    ...
    private final AutofillManagerWrapper mAutofillManager;
    private ViewGroup mContainerView;
    private WebContents mWebContents;

    private AutofillRequest mRequest;
    private long mNativeAutofillProvider;
    private final AutofillProviderUMA mAutofillUMA;
    private final AutofillManagerWrapper.InputUIObserver mInputUIObserver;
