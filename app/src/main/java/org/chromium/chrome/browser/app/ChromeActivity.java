...
public abstract class ChromeActivity<C extends ChromeActivityComponent>
    ...
    private final ObservableSupplierImpl<LayoutManagerImpl> mLayoutManagerSupplier =
            new ObservableSupplierImpl<>();
    private final ObservableSupplierImpl<ShareDelegate> mShareDelegateSupplier =
            new ObservableSupplierImpl<>();
    ...
    private final List<MenuOrKeyboardActionController.MenuOrKeyboardActionHandler> mMenuActionHandlers =
            new ArrayList<>();
...
//        @Nullable
    ...
    public boolean onMenuOrKeyboardAction(int id, boolean fromMenu) {
        ...
        if (id == R.id.open_history_menu_id) {
            ...
            assert !isTablet() || currentTab != null;
