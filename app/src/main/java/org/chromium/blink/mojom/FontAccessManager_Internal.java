            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case CHOOSE_LOCAL_FONTS_ORDINAL: {
                        ...
                        getImpl().chooseLocalFonts(new FontAccessManagerChooseLocalFontsResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    }
    ...
    static final class FontAccessManagerChooseLocalFontsResponseParams extends org.chromium.mojo.bindings.Struct {
            ...
            try {
                ...
                result = new FontAccessManagerChooseLocalFontsResponseParams(elementsOrVersion);
                    ...
                    org.chromium.mojo.bindings.Decoder decoder1 = decoder0.readPointer(16, false);
                    {
                        ...
                        result.selection = new FontMetadata[si1.elementsOrVersion];
                        for (int i1 = 0; i1 < si1.elementsOrVersion; ++i1) {
                            
                            org.chromium.mojo.bindings.Decoder decoder2 = decoder1.readPointer(org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + org.chromium.mojo.bindings.BindingsHelper.POINTER_SIZE * i1, false);
                            result.selection[i1] = FontMetadata.decode(decoder2);
                        }
                    }
                    }
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            if (this.selection == null) {
                ...
                org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.selection.length, 16, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
    ...
    static class FontAccessManagerChooseLocalFontsResponseParamsForwardToCallback extends org.chromium.mojo.bindings.SideEffectFreeCloseable
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                ...
                mCallback.call(response.status, response.selection);
                return true;
            } catch (org.chromium.mojo.bindings.DeserializationException e) {
                return false;
            }
