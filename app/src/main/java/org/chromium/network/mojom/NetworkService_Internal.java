...
class NetworkService_Internal {
    ...
    private static final int ADD_ALLOWED_REQUEST_INITIATOR_FOR_PLUGIN_ORDINAL = 19;

    private static final int REMOVE_SECURITY_EXCEPTIONS_FOR_PLUGIN_ORDINAL = 20;

    private static final int ON_MEMORY_PRESSURE_ORDINAL = 21;

    private static final int ON_PEER_TO_PEER_CONNECTIONS_COUNT_CHANGE_ORDINAL = 22;

    private static final int ON_APPLICATION_STATE_CHANGE_ORDINAL = 23;

    private static final int SET_ENVIRONMENT_ORDINAL = 24;

    private static final int SET_TRUST_TOKEN_KEY_COMMITMENTS_ORDINAL = 25;

    private static final int CLEAR_SCT_AUDITING_CACHE_ORDINAL = 26;

    private static final int CONFIGURE_SCT_AUDITING_ORDINAL = 27;

    private static final int DUMP_WITHOUT_CRASHING_ORDINAL = 28;

    private static final int BIND_TEST_INTERFACE_ORDINAL = 29;

    private static final int SET_PRELOADED_FIRST_PARTY_SETS_ORDINAL = 30;
