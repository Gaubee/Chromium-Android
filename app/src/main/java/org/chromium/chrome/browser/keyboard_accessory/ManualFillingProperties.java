...
class ManualFillingProperties {
     ...
     */
    @androidx.annotation.IntDef({BAR, VISIBLE_SHEET, HIDDEN_SHEET})
     ...
     */
    @androidx.annotation.IntDef({HIDDEN, EXTENDING_KEYBOARD, WAITING_TO_REPLACE, REPLACING_KEYBOARD, FLOATING_BAR,
            FLOATING_SHEET})
    @java.lang.annotation.Retention(RetentionPolicy.SOURCE)
