...
final class NewTabCallbackProxyJni implements NewTabCallbackProxy.Natives {
  ...
  public long createNewTabCallbackProxy(NewTabCallbackProxy proxy, long tab) {
    return (long)GEN_JNI.org_chromium_weblayer_1private_NewTabCallbackProxy_createNewTabCallbackProxy(proxy, tab);
  }

  @Override
  public void deleteNewTabCallbackProxy(long proxy) {
    GEN_JNI.org_chromium_weblayer_1private_NewTabCallbackProxy_deleteNewTabCallbackProxy(proxy);
  }
