...
public final class WebPreferences extends org.chromium.mojo.bindings.Struct {
    ...
    public static WebPreferences decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new WebPreferences(elementsOrVersion);
                ...
                result.supportsMultipleWindows = decoder0.readBoolean(95, 1);
                }
                {
                    
                result.viewportEnabled = decoder0.readBoolean(95, 2);
                }
                {
                    
                result.viewportMetaEnabled = decoder0.readBoolean(95, 3);
                }
                {
                    
                result.shrinksViewportContentsToFit = decoder0.readBoolean(95, 4);
                }
                {
                    
                result.smoothScrollForFindEnabled = decoder0.readBoolean(95, 5);
                }
                {
                    
                result.mainFrameResizesAreOrientationChanges = decoder0.readBoolean(95, 6);
                }
                {
                    
                result.initializeAtMinimumPageScale = decoder0.readBoolean(95, 7);
                }
                {
                ...
                result.smartInsertDeleteEnabled = decoder0.readBoolean(128, 0);
                }
                {
                    
                result.spatialNavigationEnabled = decoder0.readBoolean(128, 1);
                }
                {
                    
                result.navigateOnDragDrop = decoder0.readBoolean(128, 2);
                }
                {
                    
                result.recordWholeDocument = decoder0.readBoolean(128, 3);
                }
                {
                ...
                result.disableFeaturesDependingOnViz = decoder0.readBoolean(131, 7);
                }
                {
                ...
                result.disableAcceleratedSmallCanvases = decoder0.readBoolean(248, 0);
                }
                {
                    
                result.forceDarkModeEnabled = decoder0.readBoolean(248, 1);
                }
                {
                    
                result.hideDownloadUi = decoder0.readBoolean(248, 2);
                }
                {
                    
                result.presentationReceiver = decoder0.readBoolean(248, 3);
                }
                {
                    
                result.mediaControlsEnabled = decoder0.readBoolean(248, 4);
                }
                {
                    
                result.doNotUpdateSelectionOnMutatingSelectionRange = decoder0.readBoolean(248, 5);
                }
                {
                    
                result.pictureInPictureEnabled = decoder0.readBoolean(248, 6);
                }
                {
                    
                result.translateServiceAvailable = decoder0.readBoolean(248, 7);
                }
                {
                    
                result.lazyLoadEnabled = decoder0.readBoolean(249, 0);
                }
                {
                    
                result.allowMixedContentUpgrades = decoder0.readBoolean(249, 1);
                }
                {
                    
                result.alwaysShowFocus = decoder0.readBoolean(249, 2);
                }
                {
                    
                result.touchDragDropEnabled = decoder0.readBoolean(249, 3);
                }
                {
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.supportsMultipleWindows, 95, 1);
        
        encoder0.encode(this.viewportEnabled, 95, 2);
        
        encoder0.encode(this.viewportMetaEnabled, 95, 3);
        
        encoder0.encode(this.shrinksViewportContentsToFit, 95, 4);
        
        encoder0.encode(this.smoothScrollForFindEnabled, 95, 5);
        
        encoder0.encode(this.mainFrameResizesAreOrientationChanges, 95, 6);
        
        encoder0.encode(this.initializeAtMinimumPageScale, 95, 7);
        ...
        encoder0.encode(this.smartInsertDeleteEnabled, 128, 0);
        
        encoder0.encode(this.spatialNavigationEnabled, 128, 1);
        
        encoder0.encode(this.navigateOnDragDrop, 128, 2);
        
        encoder0.encode(this.recordWholeDocument, 128, 3);
        ...
        encoder0.encode(this.disableFeaturesDependingOnViz, 131, 7);
        ...
        encoder0.encode(this.disableAcceleratedSmallCanvases, 248, 0);
        
        encoder0.encode(this.forceDarkModeEnabled, 248, 1);
        
        encoder0.encode(this.hideDownloadUi, 248, 2);
        
        encoder0.encode(this.presentationReceiver, 248, 3);
        
        encoder0.encode(this.mediaControlsEnabled, 248, 4);
        
        encoder0.encode(this.doNotUpdateSelectionOnMutatingSelectionRange, 248, 5);
        
        encoder0.encode(this.pictureInPictureEnabled, 248, 6);
        
        encoder0.encode(this.translateServiceAvailable, 248, 7);
        
        encoder0.encode(this.lazyLoadEnabled, 249, 0);
        
        encoder0.encode(this.allowMixedContentUpgrades, 249, 1);
        
        encoder0.encode(this.alwaysShowFocus, 249, 2);
        
        encoder0.encode(this.touchDragDropEnabled, 249, 3);
