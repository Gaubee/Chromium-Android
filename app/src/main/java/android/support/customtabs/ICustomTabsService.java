...
public interface ICustomTabsService extends android.os.IInterface
{
  ...
  class Default implements android.support.customtabs.ICustomTabsService
  {
  ...
  abstract class Stub extends android.os.Binder implements android.support.customtabs.ICustomTabsService
  {
  ...
  boolean warmup(long flags) throws android.os.RemoteException;
  boolean newSession(android.support.customtabs.ICustomTabsCallback callback) throws android.os.RemoteException;
  boolean newSessionWithExtras(android.support.customtabs.ICustomTabsCallback callback, android.os.Bundle extras) throws android.os.RemoteException;
  boolean mayLaunchUrl(android.support.customtabs.ICustomTabsCallback callback, android.net.Uri url, android.os.Bundle extras, java.util.List<android.os.Bundle> otherLikelyBundles) throws android.os.RemoteException;
  android.os.Bundle extraCommand(java.lang.String commandName, android.os.Bundle args) throws android.os.RemoteException;
  boolean updateVisuals(android.support.customtabs.ICustomTabsCallback callback, android.os.Bundle bundle) throws android.os.RemoteException;
  boolean requestPostMessageChannel(android.support.customtabs.ICustomTabsCallback callback, android.net.Uri postMessageOrigin) throws android.os.RemoteException;
  boolean requestPostMessageChannelWithExtras(android.support.customtabs.ICustomTabsCallback callback, android.net.Uri postMessageOrigin, android.os.Bundle extras) throws android.os.RemoteException;
  int postMessage(android.support.customtabs.ICustomTabsCallback callback, java.lang.String message, android.os.Bundle extras) throws android.os.RemoteException;
  boolean validateRelationship(android.support.customtabs.ICustomTabsCallback callback, int relation, android.net.Uri origin, android.os.Bundle extras) throws android.os.RemoteException;
  boolean receiveFile(android.support.customtabs.ICustomTabsCallback callback, android.net.Uri uri, int purpose, android.os.Bundle extras) throws android.os.RemoteException;
}
