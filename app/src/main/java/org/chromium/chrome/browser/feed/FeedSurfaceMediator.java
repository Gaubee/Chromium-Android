...
public class FeedSurfaceMediator
    ...
    private final boolean mHasHeaderMenu;
    ...
    FeedSurfaceMediator(FeedSurfaceCoordinator coordinator,
        ...
        assert mPageNavigationDelegate != null || !mHasHeaderMenu : "Need navigation delegate for header menu";
    ...
    private void initializePropertiesForStream() {
        ...
        stream.setStreamContentVisibility(!mHasHeader || mSectionHeader.isExpanded());
