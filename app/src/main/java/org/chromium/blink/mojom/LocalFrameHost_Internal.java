...
class LocalFrameHost_Internal {
    ...
    private static final int CAPTURE_PAINT_PREVIEW_OF_SUBFRAME_ORDINAL = 52;

    private static final int DETACH_ORDINAL = 53;

    private static final int ISSUE_KEEP_ALIVE_HANDLE_ORDINAL = 54;
...
org.chromium.mojo.bindings.InterfaceRequest<KeepAliveHandle> keepAliveHandle) {
            ...
            LocalFrameHostIssueKeepAliveHandleParams _message = new LocalFrameHostIssueKeepAliveHandleParams();
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case ISSUE_KEEP_ALIVE_HANDLE_ORDINAL: {
                        ...
                        LocalFrameHostIssueKeepAliveHandleParams data =
                                LocalFrameHostIssueKeepAliveHandleParams.deserialize(messageWithHeader.getPayload());
    ...
    static final class LocalFrameHostIssueKeepAliveHandleParams extends org.chromium.mojo.bindings.Struct {
        ...
        private LocalFrameHostIssueKeepAliveHandleParams(int version) {
            super(STRUCT_SIZE, version);
        }

        public LocalFrameHostIssueKeepAliveHandleParams() {
            this(0);
        }

        public static LocalFrameHostIssueKeepAliveHandleParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static LocalFrameHostIssueKeepAliveHandleParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static LocalFrameHostIssueKeepAliveHandleParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            LocalFrameHostIssueKeepAliveHandleParams result;
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new LocalFrameHostIssueKeepAliveHandleParams(elementsOrVersion);
                    {
