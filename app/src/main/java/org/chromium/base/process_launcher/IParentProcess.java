...
public interface IParentProcess extends android.os.IInterface
{
  ...
  class Default implements org.chromium.base.process_launcher.IParentProcess
  {
  ...
  void reportExceptionInInit(java.lang.String exception) throws android.os.RemoteException;
  // Tells the parent proces the child exited cleanly. Not oneway to ensure
  // the browser receives the message before child exits.
  ...
  void sendZygoteInfo(int zygotePid, long startupTimeMillis) throws android.os.RemoteException;
}
