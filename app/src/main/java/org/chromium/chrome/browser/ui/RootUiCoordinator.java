...
public class RootUiCoordinator
    ...
    private final Callback<LayoutManagerImpl> mLayoutManagerSupplierCallback;
    ...
    @Nullable
    private final Callback<Boolean> mOnOmniboxFocusChangedListener;
    ...
    public boolean canShowAppMenu() {
        ...
        return mFindToolbarManager == null || !mFindToolbarManager.isShowing()
