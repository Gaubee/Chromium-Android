...
public interface IChildProcessService extends android.os.IInterface
{
  ...
  class Default implements org.chromium.base.process_launcher.IChildProcessService
  {
  ...
  boolean bindToCaller(java.lang.String clazz) throws android.os.RemoteException;
  // Sets up the initial IPC channel.
  ...
  void dumpProcessStack() throws android.os.RemoteException;
}
