...
public class CachedFeatureFlags {
    ...
    private static final Map<String, Boolean> sBoolValuesReturned = new HashMap<>();
    private static final Map<String, String> sStringValuesReturned = new HashMap<>();
    private static final Map<String, Integer> sIntValuesReturned = new HashMap<>();
    private static final Map<String, Double> sDoubleValuesReturned = new HashMap<>();
