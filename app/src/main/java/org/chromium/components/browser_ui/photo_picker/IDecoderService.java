...
public interface IDecoderService extends android.os.IInterface
{
  ...
  class Default implements org.chromium.components.browser_ui.photo_picker.IDecoderService
  {
    /**
       * Decode an image.
  ...
  abstract class Stub extends android.os.Binder implements org.chromium.components.browser_ui.photo_picker.IDecoderService
  {
  ...
  /**
     ...
     * @param payload The data containing the details for the decoding request.
     */
  void decodeImage(android.os.Bundle payload, org.chromium.components.browser_ui.photo_picker.IDecoderServiceCallback listener) throws android.os.RemoteException;
}
